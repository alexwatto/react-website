            ...
            <section id="about-me" className="about">
                <div className="content">
                    ...
                    <div className="warning-content">
                        <div>
                        <svg height="70px" version="1.1" viewBox="0 0 100 68" width="100.001px" x="0px" xmlns="http://www.w3.org/2000/svg"  xmlnsXlink="http://www.w3.org/1999/xlink" y="0px"> 
                        <g id="large"> <g transform="rotate(90.625 31 37)"> <path d="M55.777,38.473l6.221-1.133c0.017-1.791-0.123-3.573-0.41-5.324l-6.321-0.19c-0.438-2.053-1.135-4.048-2.076-5.931
                        ...
                        C84.573,16.331,86.05,20.549,84.365,24.062z" fill="none" stroke="#0033c0"></path> <animatetransform attributeName="transform" begin="0s" dur="2s" from="0 78 21" repeatCount="indefinite" to="-360 78 21" type="rotate"> </animatetransform></g> </g>
                        </svg>
                        </div>
                    </div>
                    <hr />
                    <p>Sorry for any inconvenience while I build this,
                    <br /> please check back here for any more updates.
                    <br/> Please use the contact details below to get in touch with me.</p>
                    <hr/>
